...
export const metadata: Metadata = {
  ...
  description:
    "Audit, pilote, déploiement en production, run : périmètres, durées et prix publics des prestations Halfred.",
};

/**
 * Le chemin commercial vit ici, et non plus sur l'accueil.
 *
 * L'accueil présente désormais un candidat à l'embauche : y laisser une grille
 * de prix obligeait un recruteur à traverser un argumentaire de vente pour
 * savoir sur quelles technologies je travaille, et obligeait un dirigeant à
 * lire un parcours pour trouver un tarif. Deux lectures inconciliables sur une
 * même page, dont aucune n'était servie.
 *
 * `/halfred/` raconte ce qu'est Halfred et comment c'est construit ; cette
 * page-ci répond à la seule question « combien ». Le lien entre les deux est
